        ...
        <div class="row">
            <div class="col-sm-12">
                @component('common-components.breadcrumb')
                    @slot('title') Création rôle @endslot
                @endcomponent
            </div><!--end col-->
        </div>
                        ...
                        <div class="col mx-auto">
                            ...
                            <div class="js-wizard-validation-material block">
                                ...
                                <ul class="nav nav-tabs nav-tabs-alt nav-fill" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#wizard-validation-material-step1" data-toggle="tab">1. Ajouter un nouveau rôle</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <!-- END Step Tabs -->
                                <!-- Form -->
                                <form class="js-wizard-validation-material-form" method="POST" action="{{ route('roles.store') }}">
                                    @csrf
                                    <!-- Steps Content -->
